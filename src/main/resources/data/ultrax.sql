/*
 ...
 Source Schema         : ultrax

 Target Server Type    : MySQL
 Target Server Version : 80017
 File Encoding         : 65001

 Date: 02/10/2019 00:20:20
*/
...
-- ----------------------------
-- Table structure for pre_common_admincp_cmenu
-- ----------------------------
...
CREATE TABLE `pre_common_admincp_cmenu` (
  ...
  `uid` bigint(20) unsigned NOT NULL COMMENT '添加用户',
  `dateline` int(10) unsigned NOT NULL COMMENT '添加时间',
  PRIMARY KEY (`id`),
  KEY `uid` (`uid`),
  KEY `displayorder` (`displayorder`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='后台菜单收藏表';

-- ----------------------------
-- Table structure for pre_common_admincp_group
-- ----------------------------
...
) ENGINE=MyISAM AUTO_INCREMENT=6 DEFAULT CHARSET=utf8 COMMENT='后台管理组';

-- ----------------------------
-- Table structure for pre_common_admincp_member
-- ----------------------------
...
CREATE TABLE `pre_common_admincp_member` (
  ...
  PRIMARY KEY (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='后台管理成员';

-- ----------------------------
-- Table structure for pre_common_admincp_perm
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_common_admincp_session
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='后台session表';

-- ----------------------------
-- Table structure for pre_common_admingroup
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='管理组表';

-- ----------------------------
-- Table structure for pre_common_adminnote
-- ----------------------------
...
CREATE TABLE `pre_common_adminnote` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='后台留言表';

-- ----------------------------
-- Table structure for pre_common_advertisement
-- ----------------------------
...
CREATE TABLE `pre_common_advertisement` (
  ...
  PRIMARY KEY (`advid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='广告数据表';

-- ----------------------------
-- Table structure for pre_common_advertisement_custom
-- ----------------------------
...
CREATE TABLE `pre_common_advertisement_custom` (
  ...
  PRIMARY KEY (`id`),
  KEY `name` (`name`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='自定义广告数据表';

-- ----------------------------
-- Table structure for pre_common_banned
-- ----------------------------
...
CREATE TABLE `pre_common_banned` (
  ...
  `expiration` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '过期时间',
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='禁止访问表';

-- ----------------------------
-- Table structure for pre_common_block
-- ----------------------------
...
CREATE TABLE `pre_common_block` (
  ...
  `dateformat` varchar(255) NOT NULL DEFAULT '' COMMENT '时间格式： H:i； u； Ymd等',
...
-- ----------------------------
-- Table structure for pre_common_block_favorite
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='模块收藏表';

-- ----------------------------
-- Table structure for pre_common_block_item
-- ----------------------------
...
CREATE TABLE `pre_common_block_item` (
  ...
  PRIMARY KEY (`itemid`),
  KEY `bid` (`bid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='模块数据表';

-- ----------------------------
-- Table structure for pre_common_block_item_data
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='模块推荐信息表';

-- ----------------------------
-- Table structure for pre_common_block_permission
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_common_block_pic
-- ----------------------------
...
CREATE TABLE `pre_common_block_pic` (
  ...
  PRIMARY KEY (`picid`),
  KEY `bid` (`bid`,`itemid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='模块使用图片表';

-- ----------------------------
-- Table structure for pre_common_block_style
-- ----------------------------
...
) ENGINE=MyISAM AUTO_INCREMENT=110 DEFAULT CHARSET=utf8 COMMENT='模块模板表';

-- ----------------------------
-- Table structure for pre_common_block_xml
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_common_cache
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='通用缓存表';

-- ----------------------------
-- Table structure for pre_common_card
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='充值卡密表';

-- ----------------------------
-- Table structure for pre_common_card_log
-- ----------------------------
...
CREATE TABLE `pre_common_card_log` (
  ...
  `uid` bigint(20) NOT NULL DEFAULT '0' COMMENT '卡片生成者',
...
-- ----------------------------
-- Table structure for pre_common_card_type
-- ----------------------------
...
CREATE TABLE `pre_common_card_type` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='卡片分类表';

-- ----------------------------
-- Table structure for pre_common_connect_guest
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_common_credit_log
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_common_credit_log_field
-- ----------------------------
...
CREATE TABLE `pre_common_credit_log_field` (
  ...
  KEY `logid` (`logid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='积分日志详情';
...
-- ----------------------------
-- Table structure for pre_common_credit_rule_log_field
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='积分规则日志扩展表';

-- ----------------------------
-- Table structure for pre_common_cron
-- ----------------------------
...
) ENGINE=MyISAM AUTO_INCREMENT=21 DEFAULT CHARSET=utf8 COMMENT='计划任务表';

-- ----------------------------
-- Table structure for pre_common_devicetoken
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_common_district
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_common_diy_data
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='DIY模板页面数据的存档表';

-- ----------------------------
-- Table structure for pre_common_domain
-- ----------------------------
...
CREATE TABLE `pre_common_domain` (
  ...
  KEY `idtype` (`idtype`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='二级域名表';

-- ----------------------------
-- Table structure for pre_common_failedip
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='IP段记录表';

-- ----------------------------
-- Table structure for pre_common_failedlogin
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='失败登录表';

-- ----------------------------
-- Table structure for pre_common_friendlink
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_common_grouppm
-- ----------------------------
...
CREATE TABLE `pre_common_grouppm` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='群发短消息表';

-- ----------------------------
-- Table structure for pre_common_invite
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_common_magic
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='道具数据表';

-- ----------------------------
-- Table structure for pre_common_magiclog
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='道具日志表';

-- ----------------------------
-- Table structure for pre_common_mailcron
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_common_mailqueue
-- ----------------------------
...
CREATE TABLE `pre_common_member` (
  `uid` bigint(20) unsigned NOT NULL AUTO_INCREMENT COMMENT '会员id',
  ...
  KEY `regdate` (`regdate`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='用户主表';

-- ----------------------------
-- Table structure for pre_common_member_action_log
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_common_member_connect
-- ----------------------------
...
CREATE TABLE `pre_common_member_count` (
  ...
  PRIMARY KEY (`uid`),
  KEY `posts` (`posts`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户统计表';

-- ----------------------------
-- Table structure for pre_common_member_crime
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户惩罚操作表';

-- ----------------------------
-- Table structure for pre_common_member_field_forum
-- ----------------------------
...
CREATE TABLE `pre_common_member_field_forum` (
  ...
  PRIMARY KEY (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户论坛字段表';

-- ----------------------------
-- Table structure for pre_common_member_field_home
-- ----------------------------
...
CREATE TABLE `pre_common_member_field_home` (
  ...
  PRIMARY KEY (`uid`),
  KEY `domain` (`domain`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户家园字段表';

-- ----------------------------
-- Table structure for pre_common_member_forum_buylog
-- ----------------------------
...
CREATE TABLE `pre_common_member_forum_buylog` (
  ...
  PRIMARY KEY (`uid`,`fid`),
  KEY `fid` (`fid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户版块积分付费记录';

-- ----------------------------
-- Table structure for pre_common_member_grouppm
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='群发短消息用户记录表';

-- ----------------------------
-- Table structure for pre_common_member_log
-- ----------------------------
...
CREATE TABLE `pre_common_member_log` (
  ...
  `dateline` int(10) unsigned NOT NULL DEFAULT '0',
  PRIMARY KEY (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='漫游用户日志表';

-- ----------------------------
-- Table structure for pre_common_member_magic
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户道具数据表';

-- ----------------------------
-- Table structure for pre_common_member_medal
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户勋章数据表';
...
CREATE TABLE `pre_common_member_newprompt` (
  ...
  PRIMARY KEY (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户新提醒数量表';

-- ----------------------------
-- Table structure for pre_common_member_profile
-- ----------------------------
...
CREATE TABLE `pre_common_member_profile` (
  ...
  `gender` tinyint(1) NOT NULL DEFAULT '0' COMMENT '性别n(0:保密 1:男 2:女)',
  ...
  PRIMARY KEY (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户栏目表';

-- ----------------------------
-- Table structure for pre_common_member_profile_setting
-- ----------------------------
...
CREATE TABLE `pre_common_member_profile_setting` (
  ...
  PRIMARY KEY (`fieldid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='个人信息扩展表';

-- ----------------------------
-- Table structure for pre_common_member_security
-- ----------------------------
...
CREATE TABLE `pre_common_member_security` (
  ...
  KEY `uid` (`uid`,`fieldid`),
  KEY `dateline` (`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='个人信息修改审核';

-- ----------------------------
-- Table structure for pre_common_member_secwhite
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_common_member_stat_field
-- ----------------------------
...
CREATE TABLE `pre_common_member_stat_field` (
  ...
  KEY `fieldid` (`fieldid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户资料统计项';
...
-- ----------------------------
-- Table structure for pre_common_member_validate
-- ----------------------------
...
CREATE TABLE `pre_common_member_validate` (
  ...
  PRIMARY KEY (`uid`),
  KEY `status` (`status`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户审核表';

-- ----------------------------
-- Table structure for pre_common_member_verify
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_common_member_verify_info
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_common_myapp
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='漫游应用表';

-- ----------------------------
-- Table structure for pre_common_myinvite
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_common_mytask
-- ----------------------------
...
CREATE TABLE `pre_common_mytask` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '任务状态n(1:失败 0:进行中 1:已完成)',
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='我的任务表';

-- ----------------------------
-- Table structure for pre_common_nav
-- ----------------------------
...
CREATE TABLE `pre_common_nav` (
  ...
  `target` tinyint(1) NOT NULL DEFAULT '0' COMMENT '目标框架n(0:本窗口 1:新窗口)',
  ...
  `level` tinyint(1) NOT NULL DEFAULT '0' COMMENT '使用等级n(0:游客 1:会员 2:版主 3:管理员)',
  ...
  `navtype` tinyint(1) NOT NULL DEFAULT '0' COMMENT '导航类型n(0:主导航 1:底部导航 2:家园导航 3:快捷导航 4:顶部导航)',
  `logo` varchar(255) NOT NULL COMMENT '自定义 Logo',
  PRIMARY KEY (`id`),
  KEY `navtype` (`navtype`)
) ENGINE=MyISAM AUTO_INCREMENT=46 DEFAULT CHARSET=utf8 COMMENT='自定义导航栏表';

-- ----------------------------
-- Table structure for pre_common_onlinetime
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_common_optimizer
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_common_patch
-- ----------------------------
...
CREATE TABLE `pre_common_patch` (
  ...
  PRIMARY KEY (`serial`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='漏洞补丁表';
...
-- ----------------------------
-- Table structure for pre_common_process
-- ----------------------------
...
CREATE TABLE `pre_common_process` (
  ...
  KEY `expiry` (`expiry`)
) ENGINE=MEMORY DEFAULT CHARSET=utf8 COMMENT='进程锁管理';

-- ----------------------------
-- Table structure for pre_common_regip
-- ----------------------------
...
CREATE TABLE `pre_common_regip` (
  ...
  KEY `ip` (`ip`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='注册IP限制表';

-- ----------------------------
-- Table structure for pre_common_relatedlink
-- ----------------------------
...
CREATE TABLE `pre_common_relatedlink` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='关联链接表';

-- ----------------------------
-- Table structure for pre_common_remote_port
-- ----------------------------
...
CREATE TABLE `pre_common_remote_port` (
  ...
  PRIMARY KEY (`id`,`idtype`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='帖时的端口号';

-- ----------------------------
-- Table structure for pre_common_report
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_common_searchindex
-- ----------------------------
...
CREATE TABLE `pre_common_searchindex` (
  ...
  KEY `srchmod` (`srchmod`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='搜索缓存表';

-- ----------------------------
-- Table structure for pre_common_seccheck
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_common_secquestion
-- ----------------------------
...
CREATE TABLE `pre_common_secquestion` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='验证问题数据表';
...
-- ----------------------------
-- Table structure for pre_common_smiley
-- ----------------------------
...
) ENGINE=MyISAM AUTO_INCREMENT=86 DEFAULT CHARSET=utf8 COMMENT='表情表';

-- ----------------------------
-- Table structure for pre_common_sphinxcounter
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_common_stat
-- ----------------------------
...
CREATE TABLE `pre_common_stat` (
  ...
  PRIMARY KEY (`daytime`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='趋势统计';
...
CREATE TABLE `pre_common_statuser` (
  ...
  KEY `uid` (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='统计用户表';

-- ----------------------------
-- Table structure for pre_common_style
-- ----------------------------
...
CREATE TABLE `pre_common_style` (
  ...
  PRIMARY KEY (`styleid`)
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='风格表';

-- ----------------------------
-- Table structure for pre_common_stylevar
-- ----------------------------
...
CREATE TABLE `pre_common_stylevar` (
  ...
  KEY `styleid` (`styleid`)
) ENGINE=MyISAM AUTO_INCREMENT=46 DEFAULT CHARSET=utf8 COMMENT='风格变量表';
...
CREATE TABLE `pre_common_syscache` (
  ...
  PRIMARY KEY (`cname`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='缓存数据表';

-- ----------------------------
-- Table structure for pre_common_tag
-- ----------------------------
...
CREATE TABLE `pre_common_tag` (
  ...
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '显示状态n(0:正常 1:关闭 2:推荐 3:用户标签)',
  PRIMARY KEY (`tagid`),
  KEY `tagname` (`tagname`),
...
-- ----------------------------
-- Table structure for pre_common_tagitem
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='标签内容表';

-- ----------------------------
-- Table structure for pre_common_task
-- ----------------------------
...
CREATE TABLE `pre_common_task` (
  ...
  `relatedtaskid` smallint(6) unsigned NOT NULL DEFAULT '0' COMMENT '依存任务idn必须完成依存任务才能申请该任务',
  `available` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否启用',
  ...
  `reward` enum('credit','magic','medal','invite','group') NOT NULL DEFAULT 'credit' COMMENT '奖励类型n(credit:积分 magic:道具 medal:勋章 invite:邀请码 group:特殊用户组)',
  `prize` varchar(15) NOT NULL DEFAULT '' COMMENT '奖品: 哪一个扩展积分, 道具id, 勋章id,邀请码有效期， 特殊用户组id',
  `bonus` int(10) NOT NULL DEFAULT '0' COMMENT '奖品数量/有效期: n积分数量, 道具数量, 勋章有效期, 邀请码数量，特殊用户组有效期',
  `displayorder` smallint(6) unsigned NOT NULL DEFAULT '0' COMMENT '显示顺序',
  `version` varchar(15) NOT NULL DEFAULT '' COMMENT '任务脚本版本号',
  PRIMARY KEY (`taskid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='论坛任务表';

-- ----------------------------
-- Table structure for pre_common_taskvar
-- ----------------------------
...
CREATE TABLE `pre_common_taskvar` (
  ...
  `sort` enum('apply','complete') NOT NULL DEFAULT 'complete' COMMENT '变量类别n(apply:申请任务条件 complete:完成任务条件)',
  ...
  KEY `taskid` (`taskid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='论坛任务设置表';

-- ----------------------------
-- Table structure for pre_common_template
-- ----------------------------
...
) ENGINE=MyISAM AUTO_INCREMENT=2 DEFAULT CHARSET=utf8 COMMENT='模板表';

-- ----------------------------
-- Table structure for pre_common_template_block
-- ----------------------------
...
CREATE TABLE `pre_common_template_block` (
  ...
  KEY `bid` (`bid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='模板页面和模块的关联表';

-- ----------------------------
-- Table structure for pre_common_template_permission
-- ----------------------------
...
CREATE TABLE `pre_common_template_permission` (
  ...
  KEY `uid` (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='DIY模板页面权限表';

-- ----------------------------
-- Table structure for pre_common_uin_black
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_common_usergroup_field
-- ----------------------------
...
CREATE TABLE `pre_common_usergroup_field` (
  ...
  PRIMARY KEY (`groupid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='会员用户组权限表';

-- ----------------------------
-- Table structure for pre_common_visit
-- ----------------------------
...
CREATE TABLE `pre_common_visit` (
  ...
  PRIMARY KEY (`ip`),
  KEY `ip` (`ip`,`view`)
) ENGINE=MEMORY DEFAULT CHARSET=utf8 COMMENT='用户访问日志表';

-- ----------------------------
-- Table structure for pre_common_word
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_common_word_type
-- ----------------------------
...
CREATE TABLE `pre_common_word_type` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=MyISAM AUTO_INCREMENT=3 DEFAULT CHARSET=utf8 COMMENT='词语过滤分类';

-- ----------------------------
-- Table structure for pre_connect_disktask
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_connect_feedlog
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_connect_memberbindlog
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_connect_postfeedlog
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_connect_tthreadlog
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_forum_access
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='访问权限表';

-- ----------------------------
-- Table structure for pre_forum_activity
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_forum_activityapply
-- ----------------------------
...
CREATE TABLE `pre_forum_activityapply` (
  ...
  `verified` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否审核通过n(0:N 1:Y 2:需完善资料)',
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='活动申请表';

-- ----------------------------
-- Table structure for pre_forum_announcement
-- ----------------------------
...
CREATE TABLE `pre_forum_announcement` (
  ...
  `type` tinyint(1) NOT NULL DEFAULT '0' COMMENT '公告类型n(0:文字公告 1:网址链接)',
  `displayorder` tinyint(3) NOT NULL DEFAULT '0' COMMENT '显示顺序',
  `starttime` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '开始时间',
  `endtime` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '结束时间',
  `message` text NOT NULL COMMENT '消息',
...
-- ----------------------------
-- Table structure for pre_forum_attachment
-- ----------------------------
...
CREATE TABLE `pre_forum_attachment` (
  ...
  KEY `pid` (`pid`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='附件索引表';

-- ----------------------------
-- Table structure for pre_forum_attachment_0
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_forum_attachment_1
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_forum_attachment_2
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_forum_attachment_3
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_forum_attachment_4
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_forum_attachment_5
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_forum_attachment_6
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_forum_attachment_7
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_forum_attachment_8
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_forum_attachment_9
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_forum_attachment_exif
-- ----------------------------
...
CREATE TABLE `pre_forum_attachment_exif` (
  ...
  PRIMARY KEY (`aid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='Exif缓存表';

-- ----------------------------
-- Table structure for pre_forum_attachment_unused
-- ----------------------------
...
CREATE TABLE `pre_forum_attachment_unused` (
  ...
  PRIMARY KEY (`aid`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='未使用附件表';

-- ----------------------------
-- Table structure for pre_forum_attachtype
-- ----------------------------
...
CREATE TABLE `pre_forum_attachtype` (
  ...
  PRIMARY KEY (`id`),
  KEY `fid` (`fid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='附件类型表';

-- ----------------------------
-- Table structure for pre_forum_bbcode
-- ----------------------------
...
CREATE TABLE `pre_forum_bbcode` (
  ...
  `available` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否启用n(0:不启用 1:启用但不显示 2:启用并显示)',
...
-- ----------------------------
-- Table structure for pre_forum_collection
-- ----------------------------
...
CREATE TABLE `pre_forum_collection` (
  ...
  KEY `uid` (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='淘帖专辑表';

-- ----------------------------
-- Table structure for pre_forum_collectioncomment
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='淘帖评论表';

-- ----------------------------
-- Table structure for pre_forum_collectionfollow
-- ----------------------------
...
CREATE TABLE `pre_forum_collectionfollow` (
  ...
  KEY `ctid` (`ctid`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='淘帖关注表';

-- ----------------------------
-- Table structure for pre_forum_collectioninvite
-- ----------------------------
...
CREATE TABLE `pre_forum_collectioninvite` (
  ...
  KEY `dateline` (`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='邀请管理淘专辑';

-- ----------------------------
-- Table structure for pre_forum_collectionrelated
-- ----------------------------
...
CREATE TABLE `pre_forum_collectionrelated` (
  ...
  PRIMARY KEY (`tid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='淘帖主题被收入专辑表';

-- ----------------------------
-- Table structure for pre_forum_collectionteamworker
-- ----------------------------
...
CREATE TABLE `pre_forum_collectionteamworker` (
  ...
  PRIMARY KEY (`ctid`,`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='淘帖合作编辑表';

-- ----------------------------
-- Table structure for pre_forum_collectionthread
-- ----------------------------
...
CREATE TABLE `pre_forum_collectionthread` (
  ...
  KEY `ctid` (`ctid`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='淘帖包含主题表';

-- ----------------------------
-- Table structure for pre_forum_creditslog
-- ----------------------------
...
CREATE TABLE `pre_forum_creditslog` (
  ...
  KEY `uid` (`uid`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='转帐记录表';

-- ----------------------------
-- Table structure for pre_forum_debate
-- ----------------------------
...
CREATE TABLE `pre_forum_debate` (
  ...
  `winner` tinyint(1) NOT NULL DEFAULT '0' COMMENT '获胜方n(0:平局 1:为正方 2:为反方)n裁判评判结果',
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='辩论主题表';

-- ----------------------------
-- Table structure for pre_forum_debatepost
-- ----------------------------
DROP TABLE IF EXISTS `pre_forum_debatepost`;
CREATE TABLE `pre_forum_debatepost` (
  `pid` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '帖子id',
  `stand` tinyint(1) NOT NULL DEFAULT '0' COMMENT '立场n(0:中立 1:正方 2:为反方)',
  `tid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '主题id',
  `uid` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '发起人id',
  ...
  KEY `pid` (`pid`,`stand`),
  KEY `tid` (`tid`,`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='辩论帖子表';

-- ----------------------------
-- Table structure for pre_forum_faq
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='论坛帮助表';

-- ----------------------------
-- Table structure for pre_forum_filter_post
-- ----------------------------
...
CREATE TABLE `pre_forum_forum` (
  ...
  `type` enum('group','forum','sub') NOT NULL DEFAULT 'forum' COMMENT '类型n(group:分类 forum:普通论坛 sub:子论坛)',
  `name` char(50) NOT NULL DEFAULT '' COMMENT '名称',
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '显示状态n(0:隐藏 1:正常 3:群组)',
  `displayorder` smallint(6) NOT NULL DEFAULT '0' COMMENT '显示顺序',
  `styleid` smallint(6) unsigned NOT NULL DEFAULT '0' COMMENT '风格id',
  ...
  KEY `fup` (`fup`)
) ENGINE=MyISAM AUTO_INCREMENT=36 DEFAULT CHARSET=utf8 COMMENT='版块表';

-- ----------------------------
-- Table structure for pre_forum_forum_threadtable
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='版块存档信息';

-- ----------------------------
-- Table structure for pre_forum_forumfield
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='版块扩展表';

-- ----------------------------
-- Table structure for pre_forum_forumrecommend
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='版主推荐表';

-- ----------------------------
-- Table structure for pre_forum_groupcreditslog
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='群组积分日志表';

-- ----------------------------
-- Table structure for pre_forum_groupfield
-- ----------------------------
...
CREATE TABLE `pre_forum_groupfield` (
  ...
  KEY `fid` (`fid`),
  KEY `type` (`type`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='群组扩展信息缓存';

-- ----------------------------
-- Table structure for pre_forum_groupinvite
-- ----------------------------
...
CREATE TABLE `pre_forum_groupinvite` (
  ...
  KEY `dateline` (`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='群组邀请';

-- ----------------------------
-- Table structure for pre_forum_grouplevel
-- ----------------------------
...
CREATE TABLE `pre_forum_grouplevel` (
  ...
  PRIMARY KEY (`levelid`),
  KEY `creditsrange` (`creditshigher`,`creditslower`)
) ENGINE=MyISAM AUTO_INCREMENT=4 DEFAULT CHARSET=utf8 COMMENT='群组等级表';

-- ----------------------------
-- Table structure for pre_forum_groupuser
-- ----------------------------
DROP TABLE IF EXISTS `pre_forum_groupuser`;
CREATE TABLE `pre_forum_groupuser` (
  `fid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '群组关联fid',
  `uid` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '成员id',
  `username` char(15) NOT NULL COMMENT '成员名',
  `level` tinyint(3) unsigned NOT NULL DEFAULT '0' COMMENT '成员等级n(0:待审核 1:群主 2:副群主 3:明星成员 4:普通成员)',
...
-- ----------------------------
-- Table structure for pre_forum_hotreply_member
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_forum_hotreply_number
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_forum_imagetype
-- ----------------------------
...
CREATE TABLE `pre_forum_imagetype` (
  ...
  `type` enum('smiley','icon','avatar') NOT NULL DEFAULT 'smiley' COMMENT '分类类型n(smiley:表情 icon:图标 avatar:头像)',
...
-- ----------------------------
-- Table structure for pre_forum_medal
-- ----------------------------
...
) ENGINE=MyISAM AUTO_INCREMENT=11 DEFAULT CHARSET=utf8 COMMENT='勋章表';

-- ----------------------------
-- Table structure for pre_forum_medallog
-- ----------------------------
DROP TABLE IF EXISTS `pre_forum_medallog`;
CREATE TABLE `pre_forum_medallog` (
  `id` mediumint(8) unsigned NOT NULL AUTO_INCREMENT COMMENT '记录id',
  `uid` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '勋章拥有着用户id',
  ...
  KEY `dateline` (`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='勋章日志表';

-- ----------------------------
-- Table structure for pre_forum_memberrecommend
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户推荐表';

-- ----------------------------
-- Table structure for pre_forum_moderator
-- ----------------------------
...
CREATE TABLE `pre_forum_moderator` (
  ...
  PRIMARY KEY (`uid`,`fid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='版主表';

-- ----------------------------
-- Table structure for pre_forum_modwork
-- ----------------------------
...
CREATE TABLE `pre_forum_modwork` (
  ...
  KEY `uid` (`uid`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='论坛管理统计表';

-- ----------------------------
-- Table structure for pre_forum_newthread
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_forum_onlinelist
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='在线列表定制';

-- ----------------------------
-- Table structure for pre_forum_order
-- ----------------------------
...
CREATE TABLE `pre_forum_order` (
  ...
  `uid` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '购买者id',
...
-- ----------------------------
-- Table structure for pre_forum_poll
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_forum_polloption
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_forum_polloption_image
-- ----------------------------
...
CREATE TABLE `pre_forum_polloption_image` (
  ...
  KEY `tid` (`tid`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='投票选项图片';

-- ----------------------------
-- Table structure for pre_forum_pollvoter
-- ----------------------------
...
CREATE TABLE `pre_forum_pollvoter` (
  ...
  `options` text NOT NULL COMMENT '选项 t 分隔',
  `dateline` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '发表时间',
  KEY `tid` (`tid`),
  KEY `uid` (`uid`,`dateline`)
...
-- ----------------------------
-- Table structure for pre_forum_post
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_forum_post_location
-- ----------------------------
...
CREATE TABLE `pre_forum_post_location` (
  ...
  KEY `tid` (`tid`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='帖子地理位置表';

-- ----------------------------
-- Table structure for pre_forum_post_moderate
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='帖子审核数据表';

-- ----------------------------
-- Table structure for pre_forum_post_tableid
-- ----------------------------
...
CREATE TABLE `pre_forum_post_tableid` (
  ...
  PRIMARY KEY (`pid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='post分表协调表';

-- ----------------------------
-- Table structure for pre_forum_postcache
-- ----------------------------
...
CREATE TABLE `pre_forum_postcache` (
  ...
  PRIMARY KEY (`pid`),
  KEY `dateline` (`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='论坛帖子缓存表';

-- ----------------------------
-- Table structure for pre_forum_postcomment
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='点评帖子表';

-- ----------------------------
-- Table structure for pre_forum_postlog
-- ----------------------------
...
CREATE TABLE `pre_forum_postlog` (
  ...
  KEY `uid` (`uid`),
  KEY `dateline` (`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='漫游帖子日志';

-- ----------------------------
-- Table structure for pre_forum_poststick
-- ----------------------------
...
CREATE TABLE `pre_forum_poststick` (
  ...
  PRIMARY KEY (`tid`,`pid`),
  KEY `dateline` (`tid`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='回帖置顶表';

-- ----------------------------
-- Table structure for pre_forum_promotion
-- ----------------------------
...
CREATE TABLE `pre_forum_promotion` (
  ...
  `username` char(15) NOT NULL DEFAULT '' COMMENT '会员名',
  PRIMARY KEY (`ip`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='论坛推广';

-- ----------------------------
-- Table structure for pre_forum_ratelog
-- ----------------------------
...
CREATE TABLE `pre_forum_ratelog` (
  ...
  KEY `dateline` (`dateline`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='帖子评分记录表';

-- ----------------------------
-- Table structure for pre_forum_relatedthread
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='相关主题表';

-- ----------------------------
-- Table structure for pre_forum_replycredit
-- ----------------------------
...
CREATE TABLE `pre_forum_replycredit` (
  ...
  PRIMARY KEY (`tid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='主题回帖获得积分规则表';

-- ----------------------------
-- Table structure for pre_forum_rsscache
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='rss缓存表';

-- ----------------------------
-- Table structure for pre_forum_sofa
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_forum_spacecache
-- ----------------------------
DROP TABLE IF EXISTS `pre_forum_spacecache`;
CREATE TABLE `pre_forum_spacecache` (
  `uid` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '用户 uid',
  `variable` varchar(20) NOT NULL COMMENT '缓存变量的名称',
  `value` text NOT NULL COMMENT '缓存变量的值',
  `expiration` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '过期时间',
  PRIMARY KEY (`uid`,`variable`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='minispace缓存表';

-- ----------------------------
-- Table structure for pre_forum_statlog
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='版块统计日志表';

-- ----------------------------
-- Table structure for pre_forum_thread
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_forum_thread_moderate
-- ----------------------------
...
CREATE TABLE `pre_forum_thread_moderate` (
  ...
  PRIMARY KEY (`id`),
  KEY `status` (`status`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='主题审核数据表';

-- ----------------------------
-- Table structure for pre_forum_threadaddviews
-- ----------------------------
...
CREATE TABLE `pre_forum_threadaddviews` (
  ...
  PRIMARY KEY (`tid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='主题查看数延时更新表';

-- ----------------------------
-- Table structure for pre_forum_threadcalendar
-- ----------------------------
...
CREATE TABLE `pre_forum_threadcalendar` (
  ...
  PRIMARY KEY (`cid`),
  KEY `fid` (`fid`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='热帖日历表';

-- ----------------------------
-- Table structure for pre_forum_threadclass
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_forum_threadclosed
-- ----------------------------
...
CREATE TABLE `pre_forum_threadclosed` (
  ...
  PRIMARY KEY (`tid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='主题转移后保留的指向记录';

-- ----------------------------
-- Table structure for pre_forum_threaddisablepos
-- ----------------------------
DROP TABLE IF EXISTS `pre_forum_threaddisablepos`;
CREATE TABLE `pre_forum_threaddisablepos` (
  `tid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '主题id',
  PRIMARY KEY (`tid`)
) ENGINE=MEMORY DEFAULT CHARSET=utf8 COMMENT='主题有楼层不准确时不使用position查询';

-- ----------------------------
-- Table structure for pre_forum_threadhidelog
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='主题隐藏记录';

-- ----------------------------
-- Table structure for pre_forum_threadhot
-- ----------------------------
...
CREATE TABLE `pre_forum_threadhot` (
  ...
  PRIMARY KEY (`cid`,`tid`),
  KEY `fid` (`fid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='热帖日历数据表';

-- ----------------------------
-- Table structure for pre_forum_threadimage
-- ----------------------------
...
CREATE TABLE `pre_forum_threadimage` (
  ...
  `remote` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '是否远程附件',
  KEY `tid` (`tid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='主题图片表';

-- ----------------------------
-- Table structure for pre_forum_threadlog
-- ----------------------------
...
CREATE TABLE `pre_forum_threadlog` (
  ...
  KEY `dateline` (`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='漫游主题日志';

-- ----------------------------
-- Table structure for pre_forum_threadmod
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='主题管理记录表';

-- ----------------------------
-- Table structure for pre_forum_threadpartake
-- ----------------------------
...
CREATE TABLE `pre_forum_threadpartake` (
  ...
  KEY `tid` (`tid`,`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='主题参与者记录表';

-- ----------------------------
-- Table structure for pre_forum_threadpreview
-- ----------------------------
...
CREATE TABLE `pre_forum_threadpreview` (
  ...
  PRIMARY KEY (`tid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='服务于广播';

-- ----------------------------
-- Table structure for pre_forum_threadprofile
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_forum_threadprofile_group
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_forum_threadrush
-- ----------------------------
...
CREATE TABLE `pre_forum_threadrush` (
  ...
  PRIMARY KEY (`tid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='抢楼设置表';

-- ----------------------------
-- Table structure for pre_forum_threadtype
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_forum_trade
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_forum_tradecomment
-- ----------------------------
...
CREATE TABLE `pre_forum_tradecomment` (
  ...
  KEY `orderid` (`orderid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='信用评价';

-- ----------------------------
-- Table structure for pre_forum_tradelog
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_forum_typeoption
-- ----------------------------
...
CREATE TABLE `pre_forum_typeoption` (
  ...
  PRIMARY KEY (`optionid`),
  KEY `classid` (`classid`)
) ENGINE=MyISAM AUTO_INCREMENT=7 DEFAULT CHARSET=utf8 COMMENT='分类信息设置项目表';

-- ----------------------------
-- Table structure for pre_forum_typeoptionvar
-- ----------------------------
...
CREATE TABLE `pre_forum_typeoptionvar` (
  ...
  KEY `tid` (`tid`),
  KEY `fid` (`fid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='分类信息项目数据表';

-- ----------------------------
-- Table structure for pre_forum_typevar
-- ----------------------------
...
CREATE TABLE `pre_forum_typevar` (
  ...
  KEY `sortid` (`sortid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='分类信息对应项目表';

-- ----------------------------
-- Table structure for pre_forum_warning
-- ----------------------------
...
CREATE TABLE `pre_forum_warning` (
  ...
  UNIQUE KEY `pid` (`pid`),
  KEY `authorid` (`authorid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='警告记录表';

-- ----------------------------
-- Table structure for pre_home_album
-- ----------------------------
...
CREATE TABLE `pre_home_album` (
  ...
  `uid` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '相册用户ID',
...
-- ----------------------------
-- Table structure for pre_home_album_category
-- ----------------------------
...
CREATE TABLE `pre_home_album_category` (
  ...
  `displayorder` smallint(6) NOT NULL DEFAULT '0' COMMENT '显示顺序',
  PRIMARY KEY (`catid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='相册系统栏目';

-- ----------------------------
-- Table structure for pre_home_appcreditlog
-- ----------------------------
...
CREATE TABLE `pre_home_appcreditlog` (
  ...
  KEY `uid` (`uid`,`dateline`),
  KEY `appid` (`appid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='漫游应用积分操作记录表';

-- ----------------------------
-- Table structure for pre_home_blacklist
-- ----------------------------
...
CREATE TABLE `pre_home_blacklist` (
  ...
  KEY `uid` (`uid`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='屏蔽黑名单表';

-- ----------------------------
-- Table structure for pre_home_blog
-- ----------------------------
...
CREATE TABLE `pre_home_blog` (
  ...
  `uid` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '日志所属用户ID',
...
-- ----------------------------
-- Table structure for pre_home_blog_category
-- ----------------------------
...
CREATE TABLE `pre_home_blog_category` (
  ...
  `displayorder` smallint(6) NOT NULL DEFAULT '0' COMMENT '显示顺序',
  PRIMARY KEY (`catid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='日志系统栏目';

-- ----------------------------
-- Table structure for pre_home_blog_moderate
-- ----------------------------
...
CREATE TABLE `pre_home_blog_moderate` (
  ...
  PRIMARY KEY (`id`),
  KEY `status` (`status`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='日志审核数据表';

-- ----------------------------
-- Table structure for pre_home_blogfield
-- ----------------------------
...
CREATE TABLE `pre_home_blogfield` (
  ...
  PRIMARY KEY (`blogid`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='日志字段表';

-- ----------------------------
-- Table structure for pre_home_class
-- ----------------------------
...
CREATE TABLE `pre_home_class` (
  ...
  `uid` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '分类所属用户ID',
  `dateline` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '分类创建时间戳',
  PRIMARY KEY (`classid`),
  KEY `uid` (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='日志个人分类表';

-- ----------------------------
-- Table structure for pre_home_click
-- ----------------------------
...
) ENGINE=MyISAM AUTO_INCREMENT=16 DEFAULT CHARSET=utf8 COMMENT='表态动作';

-- ----------------------------
-- Table structure for pre_home_clickuser
-- ----------------------------
DROP TABLE IF EXISTS `pre_home_clickuser`;
CREATE TABLE `pre_home_clickuser` (
  `uid` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '表态用户id',
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户表态表';

-- ----------------------------
-- Table structure for pre_home_comment
-- ----------------------------
DROP TABLE IF EXISTS `pre_home_comment`;
CREATE TABLE `pre_home_comment` (
  `cid` mediumint(8) unsigned NOT NULL AUTO_INCREMENT COMMENT '评论id',
  `uid` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '发表评论的用户id',
  ...
  `status` tinyint(1) NOT NULL DEFAULT '0' COMMENT '评论状态 1审核',
  PRIMARY KEY (`cid`),
...
-- ----------------------------
-- Table structure for pre_home_comment_moderate
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='家园评论审核数据表';

-- ----------------------------
-- Table structure for pre_home_docomment
-- ----------------------------
...
CREATE TABLE `pre_home_docomment` (
  ...
  `uid` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '发布记录者用户id',
  ...
  KEY `dateline` (`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户记录回复表';

-- ----------------------------
-- Table structure for pre_home_doing
-- ----------------------------
...
CREATE TABLE `pre_home_doing` (
  ...
  `uid` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '记录发布者用户id',
  ...
  `status` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '记录状态 1审核',
  PRIMARY KEY (`doid`),
  KEY `uid` (`uid`,`dateline`),
  KEY `dateline` (`dateline`)
...
-- ----------------------------
-- Table structure for pre_home_doing_moderate
-- ----------------------------
...
CREATE TABLE `pre_home_doing_moderate` (
  ...
  PRIMARY KEY (`id`),
  KEY `status` (`status`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='记录审核数据表';

-- ----------------------------
-- Table structure for pre_home_favorite
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_home_feed
-- ----------------------------
...
CREATE TABLE `pre_home_feed` (
  ...
  `uid` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '产生feed的用户ID',
  ...
  `hash_template` varchar(32) NOT NULL DEFAULT '' COMMENT '模板hash:md5(title_template"t"body_template)',
  `hash_data` varchar(32) NOT NULL DEFAULT '' COMMENT '数据内容hash:md5(title_templat"t"title_data"t"body_template"t"body_data)',
  ...
  KEY `hot` (`hot`),
  KEY `id` (`id`,`idtype`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='站点feed表';

-- ----------------------------
-- Table structure for pre_home_feed_app
-- ----------------------------
...
CREATE TABLE `pre_home_feed_app` (
  ...
  KEY `uid` (`uid`,`dateline`),
  KEY `dateline` (`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='应该feed表';

-- ----------------------------
-- Table structure for pre_home_follow
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_home_follow_feed
-- ----------------------------
...
CREATE TABLE `pre_home_follow_feed` (
  ...
  `uid` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '被关注者ID',
  ...
  PRIMARY KEY (`feedid`),
  KEY `uid` (`uid`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='被关注者事件表';

-- ----------------------------
-- Table structure for pre_home_follow_feed_archiver
-- ----------------------------
...
CREATE TABLE `pre_home_follow_feed_archiver` (
  ...
  PRIMARY KEY (`feedid`),
  KEY `uid` (`uid`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='被关注者事件存档';

-- ----------------------------
-- Table structure for pre_home_friend
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_home_friend_request
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='申请好友表';

-- ----------------------------
-- Table structure for pre_home_friendlog
-- ----------------------------
...
CREATE TABLE `pre_home_friendlog` (
  ...
  PRIMARY KEY (`uid`,`fuid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户好友动作日志表';

-- ----------------------------
-- Table structure for pre_home_notification
-- ----------------------------
...
CREATE TABLE `pre_home_notification` (
  ...
  `uid` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '通知用户ID',
...
-- ----------------------------
-- Table structure for pre_home_pic
-- ----------------------------
...
CREATE TABLE `pre_home_pic` (
  ...
  `uid` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '图片所属用户ID',
  ...
  `status` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '图片状态 1审核',
  PRIMARY KEY (`picid`),
  KEY `uid` (`uid`),
  KEY `albumid` (`albumid`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='家园图片表';

-- ----------------------------
-- Table structure for pre_home_pic_moderate
-- ----------------------------
...
CREATE TABLE `pre_home_pic_moderate` (
  ...
  PRIMARY KEY (`id`),
  KEY `status` (`status`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='图片审核数据表';

-- ----------------------------
-- Table structure for pre_home_picfield
-- ----------------------------
...
CREATE TABLE `pre_home_picfield` (
  ...
  PRIMARY KEY (`picid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='家园图片拓展表';

-- ----------------------------
-- Table structure for pre_home_poke
-- ----------------------------
DROP TABLE IF EXISTS `pre_home_poke`;
CREATE TABLE `pre_home_poke` (
  `uid` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '接招呼的用户ID',
  ...
  KEY `uid` (`uid`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户招呼表';

-- ----------------------------
-- Table structure for pre_home_pokearchive
-- ----------------------------
...
CREATE TABLE `pre_home_pokearchive` (
  ...
  `uid` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '目标用户ID',
  ...
  PRIMARY KEY (`pid`),
  KEY `pokeuid` (`pokeuid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户招呼存档表';

-- ----------------------------
-- Table structure for pre_home_share
-- ----------------------------
...
CREATE TABLE `pre_home_share` (
  ...
  `uid` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '分享者用户id',
  ...
  `status` tinyint(1) NOT NULL COMMENT '分享条目状态 1审核',
  PRIMARY KEY (`sid`),
  KEY `uid` (`uid`,`dateline`),
  KEY `hot` (`hot`),
  KEY `dateline` (`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户分享表';

-- ----------------------------
-- Table structure for pre_home_share_moderate
-- ----------------------------
...
CREATE TABLE `pre_home_share_moderate` (
  ...
  PRIMARY KEY (`id`),
  KEY `status` (`status`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='分享审核数据表';

-- ----------------------------
-- Table structure for pre_home_show
-- ----------------------------
DROP TABLE IF EXISTS `pre_home_show`;
CREATE TABLE `pre_home_show` (
  `uid` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '我要上榜用户id',
  ...
  KEY `credit` (`credit`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户上榜表';

-- ----------------------------
-- Table structure for pre_home_specialuser
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='特殊用户表';

-- ----------------------------
-- Table structure for pre_home_userapp
-- ----------------------------
DROP TABLE IF EXISTS `pre_home_userapp`;
CREATE TABLE `pre_home_userapp` (
  `uid` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '使用应用的用户ID',
  `appid` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '应用ID',
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户使用应用表';

-- ----------------------------
-- Table structure for pre_home_userappfield
-- ----------------------------
...
CREATE TABLE `pre_home_userappfield` (
  ...
  KEY `uid` (`uid`,`appid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='用户使用应用扩展表';

-- ----------------------------
-- Table structure for pre_home_visitor
-- ----------------------------
DROP TABLE IF EXISTS `pre_home_visitor`;
CREATE TABLE `pre_home_visitor` (
  `uid` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '受访者用户id',
  ...
  KEY `vuid` (`vuid`),
  KEY `dateline` (`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='空间访问日志表';

-- ----------------------------
-- Table structure for pre_mobile_setting
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_mobile_wsq_threadlist
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_portal_article_content
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='门户文章内容表';

-- ----------------------------
-- Table structure for pre_portal_article_count
-- ----------------------------
...
CREATE TABLE `pre_portal_article_count` (
  ...
  PRIMARY KEY (`aid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='门户文章统计数据表';

-- ----------------------------
-- Table structure for pre_portal_article_moderate
-- ----------------------------
...
CREATE TABLE `pre_portal_article_moderate` (
  ...
  PRIMARY KEY (`id`),
  KEY `status` (`status`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='文章审核数据表';

-- ----------------------------
-- Table structure for pre_portal_article_related
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='门户相关文章';

-- ----------------------------
-- Table structure for pre_portal_article_title
-- ----------------------------
...
CREATE TABLE `pre_portal_article_title` (
  ...
  `dateline` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '添加时间',
  `status` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '文章状态 0已审核 1需要审核 2已忽略',
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='门户文章标题表';

-- ----------------------------
-- Table structure for pre_portal_article_trash
-- ----------------------------
...
CREATE TABLE `pre_portal_article_trash` (
  ...
  PRIMARY KEY (`aid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='门户文章回收站表';

-- ----------------------------
-- Table structure for pre_portal_attachment
-- ----------------------------
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='门户文章附件表';

-- ----------------------------
-- Table structure for pre_portal_category
-- ----------------------------
...
CREATE TABLE `pre_portal_category` (
  ...
  `uid` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '创建者ID',
  `username` varchar(255) NOT NULL DEFAULT '' COMMENT '创建者用户名',
  `dateline` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  `closed` tinyint(1) NOT NULL DEFAULT '0' COMMENT '是否关闭',
...
-- ----------------------------
-- Table structure for pre_portal_category_permission
-- ----------------------------
...
CREATE TABLE `pre_portal_category_permission` (
  ...
  KEY `uid` (`uid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='文章分类权限表';

-- ----------------------------
-- Table structure for pre_portal_comment
-- ----------------------------
...
CREATE TABLE `pre_portal_comment` (
  ...
  `port` smallint(6) unsigned NOT NULL DEFAULT '0' COMMENT '端口号',
  `dateline` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '评论时间戳',
  `status` tinyint(1) unsigned NOT NULL DEFAULT '0' COMMENT '评论状态 1审核',
  `message` text NOT NULL COMMENT '评论内容',
  PRIMARY KEY (`cid`),
  KEY `idtype` (`id`,`idtype`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='门户评论表';

-- ----------------------------
-- Table structure for pre_portal_comment_moderate
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_portal_rsscache
-- ----------------------------
...
CREATE TABLE `pre_portal_rsscache` (
  ...
  UNIQUE KEY `aid` (`aid`),
  KEY `catid` (`catid`,`dateline`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='文章rss缓存表';

-- ----------------------------
-- Table structure for pre_portal_topic
-- ----------------------------
...
CREATE TABLE `pre_portal_topic` (
  ...
  `uid` bigint(20) unsigned NOT NULL DEFAULT '0' COMMENT '创建者UID',
  `username` varchar(255) NOT NULL DEFAULT '' COMMENT '创建者用户名',
  `viewnum` mediumint(8) unsigned NOT NULL DEFAULT '0' COMMENT '查看数',
  `dateline` int(10) unsigned NOT NULL DEFAULT '0' COMMENT '创建时间',
  ...
  PRIMARY KEY (`topicid`),
  KEY `name` (`name`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='门户专题表';

-- ----------------------------
-- Table structure for pre_portal_topic_pic
-- ----------------------------
...
CREATE TABLE `pre_portal_topic_pic` (
  ...
  PRIMARY KEY (`picid`),
  KEY `topicid` (`topicid`)
) ENGINE=MyISAM DEFAULT CHARSET=utf8 COMMENT='门户专题图片表';

-- ----------------------------
-- Table structure for pre_security_evilpost
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_security_eviluser
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_security_failedlog
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_ucenter_admins
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_ucenter_applications
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_ucenter_badwords
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_ucenter_domains
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_ucenter_feeds
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_ucenter_friends
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_ucenter_mailqueue
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_ucenter_memberfields
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_ucenter_mergemembers
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_ucenter_newpm
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_ucenter_notelist
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_ucenter_pm_indexes
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_ucenter_pm_lists
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_ucenter_pm_members
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_ucenter_pm_messages_0
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_ucenter_pm_messages_1
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_ucenter_pm_messages_2
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_ucenter_pm_messages_3
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_ucenter_pm_messages_4
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_ucenter_pm_messages_5
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_ucenter_pm_messages_6
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_ucenter_pm_messages_7
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_ucenter_pm_messages_8
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_ucenter_pm_messages_9
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_ucenter_protectedmembers
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_ucenter_settings
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_ucenter_sqlcache
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_ucenter_tags
-- ----------------------------
...
-- ----------------------------
-- Table structure for pre_ucenter_vars
-- ----------------------------
